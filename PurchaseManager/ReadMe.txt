...
3. Run the facingapi app as spring boot app using you favorite IDE:
   a. From Intellij IDE - navigate to facingapi direcory, search and nevigate FacingapiApplication class, click on the "play" button.
      Else, build and run by maven or any other tool.

4. Run the manager app as spring boot app using you favorite IDE:
   a. From Intellij IDE - navigate to manager direcory, search and nevigate ManagerApplication class, click on the "play" button.
      Else, build and run by maven or other tool.

5. In the attached Postman collection (FacingApi collection), run the requests 
